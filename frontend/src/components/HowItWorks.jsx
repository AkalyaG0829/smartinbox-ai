                  ...
                  {phase === 1 ? (
                    <div className="space-y-3 animate-fade-in">
                      <div className="flex items-center gap-3 text-sm text-indigo-300">
                        <Activity className="w-4 h-4 animate-spin-slow" /> Semantic Analysis...
                      </div>
                      <div className="flex items-center gap-3 text-sm text-indigo-300/80">
                        <Activity className="w-4 h-4 animate-spin-slow animation-delay-1" /> Priority Detection...
                      </div>
                      <div className="flex items-center gap-3 text-sm text-indigo-300/60">
                        <Activity className="w-4 h-4 animate-spin-slow animation-delay-2" /> Intent Classification...
                      </div>
                    </div>
                  ) : phase >= 2 ? (
